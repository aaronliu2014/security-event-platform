...
const AI_TOPICS = {
  'prompt-injection': {
    keywords: [
      ...
      'prompt hijacking', 'prompt exfiltration', 'prompt stealing',
    ],
    color: '#f5222d',
  ...
  'adversarial-attack': {
    keywords: [
      ...
      'adversarial input', 'adversarial prompt',
    ],
    color: '#fa8c16',
  ...
  'model-stealing': {
    keywords: [
      ...
      'model reverse engineering', 'gradient leakage',
    ],
    color: '#eb2f96',
  ...
  'data-poisoning': {
    keywords: [
      ...
      'neural trojan', 'weight poisoning',
    ],
    color: '#722ed1',
  ...
  'ai-red-teaming': {
    keywords: [
      ...
      'ai bug bounty', 'model red teaming',
    ],
    color: '#13c2c2',
  ...
  'rag-security': {
    keywords: [
      ...
      'retrieval poisoning', 'vector poisoning',
    ],
    color: '#52c41a',
    label: 'RAG Security',
  },
  ...
  'ai-supply-chain': {
    keywords: [
      ...
      'model hub security', 'safetensors vulnerability',
    ],
    color: '#faad14',
